...
function wpb_add_google_fonts() {
    wp_register_style('wpb-googleFonts', 'http://fonts.googleapis.com/css?family=Permanent+Marker');
    wp_enqueue_style( 'wpb-googleFonts');
    wp_register_style('wpb-googleFonts2', 'http://fonts.googleapis.com/css?family=Gloria+Hallelujah');
    wp_enqueue_style( 'wpb-googleFonts2');
    wp_register_style('wpb-googleFonts3', 'http://fonts.googleapis.com/css?family=Merriweather:400,400italic,700,700italic,900,900italic');
    wp_enqueue_style( 'wpb-googleFonts3');
    wp_register_style('wpb-googleFonts4', 'http://fonts.googleapis.com/css?family=Maven+Pro:400,500,700,900');
    wp_enqueue_style( 'wpb-googleFonts4');
    wp_register_style('wpb-googleFonts5', 'http://fonts.googleapis.com/css?family=Cinzel:400,700,900');
    wp_enqueue_style( 'wpb-googleFonts5');
    wp_register_style('wpb-googleFonts6', 'http://fonts.googleapis.com/css?family=Life+Savers:400,700');
    wp_enqueue_style( 'wpb-googleFonts6');
    ...
    wp_register_style('wpb-googleFonts8', 'http://fonts.googleapis.com/css?family=Germania+One');
    wp_enqueue_style( 'wpb-googleFonts8');
    wp_register_style('wpb-googleFonts9', 'http://fonts.googleapis.com/css?family=Gorditas');
    wp_enqueue_style( 'wpb-googleFonts9');
    wp_register_style('wpb-googleFonts10', 'http://fonts.googleapis.com/css?family=Original+Surfer');
    wp_enqueue_style( 'wpb-googleFonts10');
    wp_register_style('wpb-googleFonts11', 'http://fonts.googleapis.com/css?family=Irish+Grover');
    wp_enqueue_style( 'wpb-googleFonts11');
    wp_register_style('wpb-googleFonts12', 'http://fonts.googleapis.com/css?family=Merienda+One');
    wp_enqueue_style( 'wpb-googleFonts12');
    wp_register_style('wpb-googleFonts13', 'http://fonts.googleapis.com/css?family=Righteous');
    wp_enqueue_style( 'wpb-googleFonts13');
    wp_register_style('wpb-googleFonts14', 'http://fonts.googleapis.com/css?family=Philosopher:400,700,400italic,700italic');
    wp_enqueue_style( 'wpb-googleFonts14');
    wp_register_style('wpb-googleFonts15', 'http://fonts.googleapis.com/css?family=Ribeye');
    wp_enqueue_style( 'wpb-googleFonts15');
    wp_register_style('wpb-googleFonts16', 'http://fonts.googleapis.com/css?family=Bubblegum+Sans');
    wp_enqueue_style( 'wpb-googleFonts16');
}
